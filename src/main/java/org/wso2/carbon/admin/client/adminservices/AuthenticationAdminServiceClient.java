...
public class AuthenticationAdminServiceClient {
    ...
    public static void init(String backEndServerURL) throws AdminServicesClientException {
    ...
    public static String login( String hostName, String userName, String password) throws AdminServicesClientException{
